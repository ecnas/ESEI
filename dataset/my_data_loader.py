...
from dataset.MyRandomResizeTransform import MyRandomResizeTransform  # MyRandomResizedCrop
    ...
    try:
        ...
        while watchdog.is_alive():
            ...
            if r is None:
                ...
                continue
            idx, batch_indices = r
            MyRandomResizeTransform.sample_image_size(idx)
            try:
...
class _DataLoaderIter(object):
    ...
    def __next__(self):
        if self.num_workers == 0:  # same-process loading
            MyRandomResizeTransform.sample_image_size(0)
